...
| `opencode_variant` | `high` | e.g. `minimal`, `high`, `max`. On OpenCode v2+, appended as `#variant` only when `opencode_model` is set; an existing model suffix takes precedence |
